/*
  ...
  - You are about to drop the `eliveries` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "eliveries" DROP CONSTRAINT "eliveries_id_client_fkey";

-- DropForeignKey
ALTER TABLE "eliveries" DROP CONSTRAINT "eliveries_id_deliveryman_fkey";

-- DropTable
DROP TABLE "eliveries";
